...
async def endgiveaway(ctx):
    """
    Termine immédiatement le giveaway en cours et choisit un gagnant.

    Usage:
    !endgiveaway - Termine le giveaway en cours
    """
    # Vérifier les permissions
    role = discord.utils.get(ctx.author.roles, id=ADMIN_ROLE_ID)
    ...
    # Vérifier s'il y a un giveaway en cours
    if not giveaways:
...
async def stopgiveaway(ctx):
    """
    Arrête le giveaway en cours sans choisir de gagnant.

    Usage:
    !stopgiveaway - Arrête le giveaway en cours
    """
    # Vérifier les permissions
    role = discord.utils.get(ctx.author.roles, id=ADMIN_ROLE_ID)
